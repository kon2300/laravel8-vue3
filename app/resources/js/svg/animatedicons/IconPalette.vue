    ...
    >
        ...
        <g id="palette">
            <g ref="dark">
                ...
                />
                <path
                    d="M65 93.5L41.8 82.2l33.9-70L99 23.5zm-21.1-12l20.4 9.9 32.5-67.2-20.3-9.9z"
                    fill="#7f746b"
                />
                <path
            ...
            <g ref="med">
                ...
                />
                <path
                    d="M61.1 88.7l-25.3-5 15-76.4 25.4 5zm-23.4-6.2l22.2 4.3 14.4-73.2-22.2-4.4z"
                    fill="#7f746b"
                />
                <path
        ...
        <g ref="pen">
            ...
            />
            <path
                d="M8.3 91.8l-5.4-3.9 40-55.3 5.3 3.8zm-3.9-4.1L8 90.3l38.7-53.6-3.6-2.6z"
                fill="#7f746b"
            />
            <path d="M35.6 53.1l11.9-16.5-4.5-3.3-11.9 16.5z" fill="#fff" />
            <path
                d="M30.3 49.9l12.6-17.3 5.3 3.8-12.5 17.4-.4-.3-4.5-3.2zm12.8-15.8L31.8 49.7l3.6 2.6 11.3-15.6z"
                fill="#7f746b"
            />
            <path
            ...
            />
            <path
                d="M5.3 94.5l-3.9-2.8 3-4.1 3.9 2.8zm-2.4-3L5.1 93l1.7-2.3-2.2-1.6z"
                fill="#7f746b"
            />
            <path
